...
$html = "
	...
	<table border='0'>
		...
		<tr>
			...
			<td><font size='8'><b>" . strtoupper($_GET['bookCode']) . "</b></font></td>
			<td width='250'></td>
			<td><font size='6'><b>" . strtoupper($_GET['maskapai']) . "</b></font><br>" . strtoupper($_GET['destinasi']) . "</td>
		</tr>
		<tr><td></td></tr>
	</table>
		<div style='width:1024px; -moz-border-radius: 20px 10px 20px 10px; -webkit-border-radius: 20px 10px 20px 10px; border-radius: 20px; border: 1px solid black; color: black; font-family: Arial; padding: 5px;'>
			...
			&nbsp; &nbsp; &nbsp; 1. " . $_GET['dlastName1'] . " "  . $_GET['dfirstName1']  . " / " . $_GET['dTitel1'] . "
	...
	<div style='width:1024px; border: 1px solid black; color: black; font-family: Arial; padding: 5px;'>
		<table border='0' width='1024'>
			...
			<tr>
				...
				<td valign='top'><b><font size='2px'>" . $_GET['owfnumber'] . "</font></b></td>
				<td valign='top'><b><font size='2px'>" . $_GET['dariKota'] . "</font></b><br><font size='2px'>" . $_GET['owjamDeparture'] . "</font></td>
				<td valign='top'><b><font size='2px'>" . $_GET['keKota'] . "</font></b><br><font size='2px'>" . $_GET['owjamArrival'] . "</font></td>
				<td valign='top'><b><font size='2px'>" . $_GET['owtgl'] . "</font></b></td>
				<td valign='top'><b><font size='2px'>" . $_GET['kelas'] . "</font></b></td>
			</tr>
			<tr>
				<td colspan='6' style='padding:0px 0px 0px 20px; border-bottom-style:solid; border-bottom-width:1px;'></td>
			</tr>
			<tr>
				<td colspan='6' style='padding:10px 0px 0px 10px;'><font size='2px'>TRANSIT : " . $_GET['pergiTransit'] . " " . $_GET['pergiTime1']  . " - " . $_GET['pergiTime2']. "</font></td>		
			</tr>
			<tr>
				<td colspan='6' style='padding:0px 0px 0px 20px; border-bottom-style:solid; border-bottom-width:1px;'></td>
			</tr>
			...
			if ($_GET['flight'] == "Return"){
			$html .="<tr>
					<td valign='top' style='padding:0px 0px 0px 20px;'><b><font size='2px'>1</font></b></td>
					<td valign='top'><b><font size='2px'>" . $_GET['rfnumber'] . "</font></b></td>
					<td valign='top'><b><font size='2px'>" . $_GET['keKota'] . "</font></b><br><font size='2px'>" . $_GET['rjamDeparture'] . "</font></td>
					<td valign='top'><b><font size='2px'>" . $_GET['dariKota'] . "</font></b><br><font size='2px'>" . $_GET['rjamArrival'] . "</font></td>
					<td valign='top'><b><font size='2px'>" . $_GET['rtgl'] . "</font></b></td>
					<td valign='top'><b><font size='2px'>" . $_GET['kelas'] . "</font></b></td>
				</tr>";
			}
			$html .="<tr>
			...
			<tr>
				<td colspan='6' style='padding:10px 0px 0px 10px;'><font size='2px'>TRANSIT : " . $_GET['pulangTransit'] . " " . $_GET['pulangTime1']  . " - " . $_GET['pulangTime2']. "</font></td>		
			</tr>
	...
	<div style='width:1024px; border: 1px solid black; color: black; font-family: Arial; padding: 5px;'>
		<table border='0' width='1024'>
			...
			<tr>
				...
				<td valign='top'><font size='2px'>" . $_GET['flight'] . "</font></td>
				<td valign='top'><font size='2px'>" . number_format($_GET['harga'])   . " IDR</font></td>
				<td valign='top'><font size='2px'>" . number_format($_GET['tax']) . " IDR</font></td>
				<td valign='top'><font size='2px'>" . number_format($_GET['other']) . " IDR</font></td>
				<td valign='top'><font size='2px'>" . number_format($_GET['ttl']) . " IDR</font></td>
			</tr>
			<tr>
				<td colspan='6' style='padding:0px 0px 0px 20px; border-bottom-style:solid; border-bottom-width:1px;'></td>
			</tr>
			<tr>
				...
				<td><b><font size='2px'>" . number_format($_GET['ttl']) . " IDR</font></b></td>
			</tr>
			</table>
	</div>
	<br>
	<div style='width:1024px; border: 1px solid black; color: black; font-family: Arial; padding: 5px;'>
		<table border='0' width='1024'>
			...
			<tr>
				<td style='width:120px; padding:10px 0px 0px 20px;'><font size='2px'>No</font></td>
				<td style='padding:10px 0px 0px 0px;'><font size='2px'>Last Name</font></td>
				<td style='padding:10px 0px 0px 0px;'><font size='2px'>First Name</font></td>
				<td style='padding:10px 0px 0px 0px;'><font size='2px'>E-Ticket</font></td>
				<td style='padding:10px 0px 0px 0px;'><font size='2px'>Title</font></td>
				<td style='padding:10px 0px 0px 0px;'><font size='2px'>Type</font></td>
				<td style='padding:10px 0px 0px 0px;'><font size='2px'>Special Request</font></td>

			</tr>";
			$x=0;
			for ($d=1;$d<=$_GET['dewasa'];$d++){
				$x++;
			$html .="<tr>
				<td valign='top' style='padding:0px 0px 0px 20px;'><font size='2px'>$x</font></td>
				<td valign='top'><font size='2px'>" . $_GET['dlastName' . $d] . "</font></td>
				<td valign='top'><font size='2px'>" . $_GET['dfirstName' . $d] . "</font></td>
				<td valign='top'><font size='2px'>" . $_GET['deTicket' . $d] . "</font></td>
				<td valign='top'><font size='2px'>" . $_GET['dTitel' . $d] . "</font></td>
			...
			for ($a=1;$a<=$_GET['anak'];$a++){
				$x++;

			$html .="<tr>
				<td valign='top' style='padding:0px 0px 0px 20px;'><font size='2px'>$x</font></td>
				<td valign='top'><font size='2px'>" . $_GET['alastName' . $a] . "</font></td>
				<td valign='top'><font size='2px'>" . $_GET['afirstName' . $a] . "</font></td>
				<td valign='top'><font size='2px'>" . $_GET['aeTicket' . $a] . "</font></td>
				<td valign='top'><font size='2px'>" . $_GET['aTitel' . $a] . "</font></td>
			...
			for ($b=1;$b<=$_GET['bayi'];$b++){
				$x++;
			$html .="<tr>
				<td valign='top' style='padding:0px 0px 0px 20px;'><font size='2px'>$x</font></td>
				<td valign='top'><font size='2px'>" . $_GET['blastName' . $b] . "</font></td>
				<td valign='top'><font size='2px'>" . $_GET['bfirstName' . $b] . "</font></td>
				<td valign='top'><font size='2px'>" . $_GET['beTicket' . $b] . "</font></td>
				<td valign='top'><font size='2px'>" . $_GET['bTitel' . $b] . "</font></td>
